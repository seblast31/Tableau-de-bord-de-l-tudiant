...
INSERT INTO `etudiant` (`ID_user`, `num_etudiant`, `nom`, `prenom`, `id_promo`, `id_formation`) VALUES
(1, 22391, 'MBOURRA', 'MAX', 'P002', 106),
(2, 22392, 'RICHARD', 'JULY', 'P002', 106),
(3, 22393, 'MARTIN', 'SEBASTIEN', 'P002', 106),
(4, 22394, 'SUN', 'RUI', 'P002', 106),
(5, 22500, 'ERRADI', 'ISMAIL', 'P002', 106);
